...
public class ScanClass extends AppCompatActivity implements AdapterView.OnItemClickListener{
    private static final String TAG = "ScanList";

    BluetoothAdapter mBluetoothAdapter;
    Button buttonScan,buttonNext;
    ListView scanList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanList.setOnItemClickListener(ScanClass.this);

        buttonNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(ScanClass.this, DeviceList.class);
